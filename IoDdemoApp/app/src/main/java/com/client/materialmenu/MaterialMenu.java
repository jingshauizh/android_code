...
public interface MaterialMenu {
	...
	/**
	 * Enable RTL movies_fragment. Flips all icons horizontally
	 * 
	 * @param rtlEnabled
	 *            true to enable RTL movies_fragment
	 */
	public void setRTLEnabled(boolean rtlEnabled);

	/**
	 * Manually set a transformation value for an
	 * {@link com.client.materialmenu.MaterialMenuDrawable.AnimationState}
	 * 
	 * @param animationState
	 *            state to set value in
	 * @param value
	 *            between
	 *            {@link com.client.materialmenu.MaterialMenuDrawable#TRANSFORMATION_START}
	 *            and
	 *            {@link com.client.materialmenu.MaterialMenuDrawable#TRANSFORMATION_END}
	 *            .
	 */
