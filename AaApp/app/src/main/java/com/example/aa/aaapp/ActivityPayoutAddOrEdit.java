...
import com.example.aa.aaapp.adapter.AdapterCategory;
import com.example.aa.aaapp.adapter.AdapterUser;
import com.example.aa.aaapp.business.BusinessAccountBook;
import com.example.aa.aaapp.business.BusinessCategory;
...
public class ActivityPayoutAddOrEdit extends ActivityFrame
	implements View.OnClickListener,NumberDialog.OnNumberDialogListener,SliderMenuView.OnSliderMenuListenerIF {
	...
	private void InitData(ModelPayout p_ModelPayout)
	{
		...
		Business_User _BusinessUser = new Business_User(this);
...
//			m_AlertDialog.dismiss();
			...
			Model_User _ModelUser = (Model_User)((Adapter)p_AdapterView.getAdapter()).getItem(p_Position);
			if(m_PayoutType.equals(_PayoutTypeArr[0]) || m_PayoutType.equals(_PayoutTypeArr[1]))
			{
				...
				RelativeLayout _Main = (RelativeLayout)arg1;
				
				
				if(mItemColor == null && mUserSelectedList == null)
				{
					mItemColor = new ArrayList<RelativeLayout>();
					mUserSelectedList = new ArrayList<Model_User>();
				}
