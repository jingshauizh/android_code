...
public class ActivityCategory extends ActivityFrame implements  SliderMenuView.OnSliderMenuListenerIF {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		InitListeners();
		BindData();
		createSliderMenu(R.array.SlideMenuCategory);
	}
