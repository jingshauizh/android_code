...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AccountBookEntityDao.createTable(db, ifNotExists);
        CategoryEntityDao.createTable(db, ifNotExists);
        PayoutEntityDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        UserEntityDao.dropTable(db, ifExists);
        AccountBookEntityDao.dropTable(db, ifExists);
        CategoryEntityDao.dropTable(db, ifExists);
        PayoutEntityDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AccountBookEntityDao.class);
        registerDaoClass(CategoryEntityDao.class);
        registerDaoClass(PayoutEntityDao.class);
    }
