...
public class ViewPagerDotsActivityDync extends FragmentActivity {
    ...
    private void initDots() {
        ...
        for (int i = 0; i < NUM_ITEMS; i++) {
            ImageView imageViewt = new ImageView(this);
            imageViewt.setImageResource(R.drawable.dot);
            ...
            imageViewt.setScaleType(ImageView.ScaleType.CENTER);
            imageViewt.setClickable(true);
            imageViewt.setPadding(25, 25, 25, 25);
            imageViewt.setEnabled(true);
            ll.addView(imageViewt);
            dots[i] = imageViewt;
        }
    }
