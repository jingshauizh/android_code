...
public class AdapterPayout extends AdapterSliderBase {
	...
	public View getView(int p_Position, View p_ConvertView, ViewGroup p_Parent) {
		...
		if (p_ConvertView == null) {
			p_ConvertView = getmLayoutInflater().inflate(R.layout.payout_list_item, null);
			_Holder = new Holder();
		...
		Business_User _BusinessUser = new Business_User(this.getmContext());
